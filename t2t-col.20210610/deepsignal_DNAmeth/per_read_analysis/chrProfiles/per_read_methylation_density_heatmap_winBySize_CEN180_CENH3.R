...
# Usage:
# /applications/R/R-4.0.0/bin/Rscript per_read_methylation_density_heatmap_winBySize_CEN180_CENH3.R Col_0_deepsignalDNAmeth_30kb_90pc t2t-col.20210610 1000 200000 CpG
