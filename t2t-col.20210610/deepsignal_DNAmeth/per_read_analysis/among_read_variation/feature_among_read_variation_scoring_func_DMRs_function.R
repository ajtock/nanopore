...
#                                                     names_prefix = "read_",
    ...
    fk_df_str_win_x <- data.frame(chr = seqnames(chr_featGR[featNum]),
                                  ...
                                  pValue = chr_featGR[featNum]$pValue,
                                  minuslog10_pValue = chr_featGR[featNum]$minuslog10_pValue,
                                  absolute_change = chr_featGR[featNum]$absolute_change,
                                  log2_fold_change = chr_featGR[featNum]$log2_fold_change,
                                  relative_change = chr_featGR[featNum]$relative_change,
                                  ml10pv_percentile = chr_featGR[featNum]$ml10pv_percentile,
                                  ac_percentile = chr_featGR[featNum]$ac_percentile,
                                  l2fc_percentile = chr_featGR[featNum]$l2fc_percentile,
                                  rc_percentile = chr_featGR[featNum]$rc_percentile,
