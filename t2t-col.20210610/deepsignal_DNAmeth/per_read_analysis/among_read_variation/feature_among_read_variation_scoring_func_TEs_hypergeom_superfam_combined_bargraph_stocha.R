...
# Analysis:
# Plot combined results of TE superfamily over- and under-representation analysis of TEs grouped by both stochasticity and mean methylation proportion

# Usage:
# conda activate R-4.0.0
# ./feature_among_read_variation_scoring_func_TEs_hypergeom_superfam_combined_bargraph_stocha.R Col_0_deepsignalDNAmeth_30kb_90pc t2t-col.20210610 CHG 0.50 'Chr1,Chr2,Chr3,Chr4,Chr5' 'TE' 'bodies' 10000 1000
# conda deactivate
