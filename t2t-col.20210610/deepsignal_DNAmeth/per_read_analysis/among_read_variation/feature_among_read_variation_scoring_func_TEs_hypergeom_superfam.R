...
# 2. TE superfammily  over- and under-representation analysis of TEs grouped by both mean within-read stochasticity and mean methylation proportion

# Usage:
# conda activate R-4.0.0
# ./feature_among_read_variation_scoring_func_TEs_hypergeom_TEsuperfam.R Col_0_deepsignalDNAmeth_30kb_90pc t2t-col.20210610 CHG 0.50 'Chr1,Chr2,Chr3,Chr4,Chr5' 'TE' 'bodies'
# conda deactivate
...
plotDir_kappa_mC <- paste0(outDir, "plots/hypergeom_TEsuperfam_", context, "_kappa_mC/")
plotDir_stocha_mC <- paste0(outDir, "plots/hypergeom_TEsuperfam_", context, "_stocha_mC/")
#plotDir_kappa_stocha <- paste0(outDir, "plots/hypergeom_TEsuperfam_", context, "_kappa_stocha/")
...
for(y in 1:length(superfamNames)) {
  ...
  ggsave(paste0(plotDir_kappa_mC,
                ...
                "_", superfamNames[y], "_TEs_hypergeomTest.pdf"),
