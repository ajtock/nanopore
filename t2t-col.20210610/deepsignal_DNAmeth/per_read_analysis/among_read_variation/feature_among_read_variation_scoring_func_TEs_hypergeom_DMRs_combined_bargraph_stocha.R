...
# ./feature_among_read_variation_scoring_func_TEs_hypergeom_DMRs_combined_bargraph_stocha.R Col_0_deepsignalDNAmeth_30kb_90pc t2t-col.20210610 CHG 0.50 'Chr1,Chr2,Chr3,Chr4,Chr5' 'TE' 'bodies' 'kss_BSseq_Rep1_hypoCHG,cmt3_BSseq_Rep1_hypoCHG,kss_BSseq_Rep1_hypoCHH,cmt3_BSseq_Rep1_hypoCHH'
# conda deactivate
...
ggsave(paste0(plotDir_stocha_mC,
              ...
              featName, "_", featRegion,
              "_", paste0(chrName, collapse = "_"), "_", context,
              "_TE_DMRs_combined_bargraph_hypergeomTest.pdf"),
       plot = bp,
       height = 8, width = 20)
