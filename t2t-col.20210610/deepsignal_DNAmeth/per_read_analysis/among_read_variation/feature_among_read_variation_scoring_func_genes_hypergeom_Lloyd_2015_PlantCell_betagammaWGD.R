...
# ./feature_among_read_variation_scoring_func_genes_hypergeom_Lloyd_2015_PlantCell_betagammaWGD.R Col_0_deepsignalDNAmeth_30kb_90pc t2t-col.20210610 CpG 0.50 'Chr1,Chr2,Chr3,Chr4,Chr5' 'gene' 'regions'
# conda deactivate
...
ggsave(paste0(plotDir_kappa_mC,
              ...
              "_betagammaWGD_genes_hypergeomTest.pdf"),
