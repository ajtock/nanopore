...
# csmit -m 200G -c 48 "/applications/R/R-4.0.0/bin/Rscript feature_among_read_variation_scoring_func_DMRs_sets.R Col_0_deepsignalDNAmeth_30kb_90pc t2t-col.20210610 CHG 0.50 1.00 'Chr1,Chr2,Chr3,Chr4,Chr5' 'cmt3_BSseq_Rep1_and_met1_BSseq_Rep1_hypoCHG' 'bodies'"
...
#featName <- "cmt3_BSseq_Rep1_and_met1_BSseq_Rep1_hypoCHG"
#featRegion <- "bodies"
...
feat <- readGFF(paste0("/home/ajt200/analysis/BSseq_leaf_Stroud_Jacobsen_2013_Cell_2014_NSMB/",
                       ...
                       "/features_6quantiles_", featName, "_DMRs_vs3reps_",
