...
# csmit -m 400G -c 48 "bash ./per_read_tsv2bed_bam_conversion_tmp.sh WT_deepsignalDNAmeth_95_30kb_MappedOn_T2T_Col 48 5G CHH Chr1" 
...
grep '${chr}' ${prefix}_${context}_raw.tsv | \
  mtsv2bedGraph_deepsignal.py --input - \
                              --mod ${context} \
                              --call-threshold 0.02 \
                              --genome /home/ajt200/analysis/nanopore/T2T_Col/T2T_Col_${chr}.fa \
                              --offset 0 \
                              --verbose | \
    sort -k1,1 -k2,2n | bgzip > ${prefix}_${context}_${chr}.bed.gz
tabix -p bed ${prefix}_${context}_${chr}.bed.gz
...
convert_bam_for_methylation_deepsignal.py --threads ${threads} \
                                          ...
                                          --mbed ${prefix}_${context}_${chr}.bed.gz \
                                          --mod ${context_lower} | \
#  /applications/samtools/samtools-1.9/samtools view -h - | \
  /applications/samtools/samtools-1.9/samtools sort -@ ${threads} -m ${sortMem} -o ${prefix}_${context}_${chr}_minimap2_sorted_BSconverted_sorted.bam
/applications/samtools/samtools-1.9/samtools index ${prefix}_${context}_${chr}_minimap2_sorted_BSconverted_sorted.bam
