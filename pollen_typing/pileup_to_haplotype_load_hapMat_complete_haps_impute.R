...
# Usage:
# ./pileup_to_haplotype_load_hapMat_complete_haps.R barcode1_120 60 0.153  
...
# Identify the top 5% of complete haplotypes
...
ggsave(paste0(plotDir, sample, "_ONT_cMMb_cM_complete_haplotypes_v161219.pdf"),
...
pdf(paste0(plotDir, sample, "_ONT_recombo_heatmap_complete_haplotypes_v161219.pdf"), height = 18, width = 10)
draw(htmp,
